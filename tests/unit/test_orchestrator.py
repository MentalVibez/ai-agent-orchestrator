...
class TestOrchestrator:
    ...
    @pytest.mark.asyncio
    async def test_coordinate_agents_multiple_agents(self, orchestrator: Orchestrator, network_agent):
    ...
    @pytest.mark.asyncio
    async def test_coordinate_agents_passes_context(self, orchestrator: Orchestrator, network_agent):
