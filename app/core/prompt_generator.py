...
provisioning needs, and deployment requirements. Provide specific recommendations."""
        ...
        base_prompt = agent_prompts.get(agent_id, "You are an expert assistant. Provide accurate and helpful responses.")
    ...
    def _generate_user_prompt(
        ...
        if previous_results:
            ...
            for i, result in enumerate(previous_results[:3], 1):  # Limit to 3 previous results
                ...
                prompt += f"{i}. {agent_id_prev}: {'Success' if success else 'Failed'} - {summary}\n"
            prompt += "\n"
