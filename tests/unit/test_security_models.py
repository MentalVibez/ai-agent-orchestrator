...
from app.models.security import AuditLogEntry, ResourceLimitsConfig, SecurityConfig
...
class TestAuditLogEntry:
    ...
    def test_initialization_required_fields(self):
        ...
        entry = AuditLogEntry(timestamp="2024-01-01T00:00:00", operation="execute", action="start")
...
class TestSecurityConfig:
    ...
    def test_initialization(self):
        ...
        config = SecurityConfig(
            agent_id="test_agent", resource_limits=limits, allowed_operations=["read"], audit_log=[]
        )
    ...
    def test_initialization_with_audit_log(self):
        ...
        audit_entry = AuditLogEntry(
            timestamp="2024-01-01T00:00:00", operation="execute", action="start"
        )

        config = SecurityConfig(
            agent_id="test_agent", resource_limits=limits, audit_log=[audit_entry]
        )
