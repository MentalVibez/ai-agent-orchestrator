...
class TestPromptGenerator:
    ...
    def test_generate_agent_prompt_with_previous_results(self, prompt_gen: PromptGenerator):
        ...
        assert "Previous" in prompts["user_prompt"] or "network_diagnostics" in prompts["user_prompt"]
    ...
    def test_generate_user_prompt_basic(self, prompt_gen: PromptGenerator):
        ...
        prompt = prompt_gen._generate_user_prompt("network_diagnostics", "Check connectivity", {}, {}, [])
    ...
    def test_enhance_prompt_with_tools(self, prompt_gen: PromptGenerator):
        ...
        prompt = "Base prompt"
        enhanced = prompt_gen.enhance_prompt_with_tools(prompt, "code_review", ["file_read", "code_search"])
