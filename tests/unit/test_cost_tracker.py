...
from app.core.cost_tracker import CostRecord, CostTracker, get_cost_tracker
...
class TestCostTracker:
    ...
    def test_calculate_cost_ollama_free(self, cost_tracker: CostTracker):
        ...
        cost = cost_tracker.calculate_cost(
            provider="ollama", model="llama2", input_tokens=1_000_000, output_tokens=1_000_000
        )
    ...
    def test_get_daily_cost_with_filters(self, cost_tracker: CostTracker):
        ...
        cost_tracker.record_cost(
            "bedrock", "model", 1000, 500, endpoint="/api/v1/orchestrate", agent_id="test_agent"
        )

        daily = cost_tracker.get_daily_cost(endpoint="/api/v1/orchestrate", agent_id="test_agent")
